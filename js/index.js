    ...
    success: function (data) {
      ...
      if (data.stream == null) {
       ...
       var cardDeck_start = '<div class="col-sm-6 col-md-4 col-lg-3">';
        ...
        var card_body ='<div class="card-body card-body-width"><h5 class="card-title">'+channelName+'</h5><p class="card-text text-muted small">Information not Available !!</p></div><hr>';
